...
if(isset($_GET['id2'])){ $max = $_GET['id2']; }else{
...
$sqlr2 = "select * from Full_Section_Reviewed_Applications WHERE ApplicationID='$ApplicationID' and not ReviewerID='$ReviewerID' and version='$max'";

$result13 = mysqli_query($conn,$sqlr2);



       if ($row13 = mysqli_fetch_assoc($result13)) { 

          

           if($row13['status']!=="submitted"){  

           

            $row14 = array("F1S4"=>"","S1"=>"","S2"=>"","S3"=>"","S4"=>"","S5"=>"","S6"=>"","S7"=>"","S8"=>"","S9"=>"","S10"=>"");

        }else{

                //get current Reviewer 

                $res1 = mysqli_query($conn,$sqlr);

                    

                    if ($r1 = mysqli_fetch_assoc($res1)) {  

                        //if current reviewer has submitted

                        if($r1['status']=="submitted"){

                            

                            $res3 = mysqli_query($conn,$sqlr2);

                            if ($row14 = mysqli_fetch_assoc($res3)) {  }
...
$sql13 = "SELECT * FROM Full_Section_Comment_Applications where ApplicationID='$ApplicationID'and version='$max'";

$res13 = mysqli_query($conn, $sql13);  



if ($row = mysqli_fetch_assoc($res13)) {

    if($row['status']=="Minor Amendments Required"||$row['status']=="Major Amendments Required"||$row['status']=="Approved"){ 

        $res12 = mysqli_query($conn, $sql13);  

        

    }elseif($row['status']=="Pending"){
      // if pending print nothing for ethics committe comments
      $updatemax=$max+1;
      $sql13 = "SELECT * FROM Full_Section_Comment_Applications where ApplicationID='$ApplicationID'and version='$updatemax'";
...
<title>
Automatic Ethical Approval System: View Application
</title>
...
<body>
  ...
  <?php 
      ...
      for($x;$x<=$max1;$x++){ ?>
        <?php  if($max==$x){ ?>
        <button type="submit" class="button" style ="background-color: #4CAF50;"onclick=" window.open('ReviewedSummarypage.php?id=<?php echo $ApplicationID ;?>&id2=<?php echo $x ;?>', '_self'); return false;" >version <?php echo $x ; ?></button>
     
        <?php  }else{ ?>
        <button type="submit" class="button" onclick=" window.open('ReviewedSummarypage.php?id=<?php echo $ApplicationID ;?>&id2=<?php echo $x ;?>', '_self'); return false;" >version <?php echo $x ; ?></button>
...
?>
    ...
    <tr> <?php while($row = mysqli_fetch_assoc($result13)) { ?>
...
while($row = mysqli_fetch_assoc($result14)) {
  ...
  <?php  if($row = mysqli_fetch_assoc($result12)) {  }?>
           ...
           <?php if($row['F1S4']==""){ }else{ ?>

           <th colspan="3">Section 4 Reviewer <?php echo $row['ReviewerID'] ?>  Feedback</th>

      

           <tr><td colspan="3"><?php echo $row['F1S4']; }?></td></tr>

        <tr> 

            <?php if($row14['F1S4']==""){ }else{ ?>

           <th colspan="3">Section 4 Reviewer <?php echo $row14['ReviewerID'] ?>  Feedback</th>

      

           <tr><td colspan="3"><?php echo $row14['F1S4']; }?></td></tr>

        </tr> 

    <tr> 

    <?php    foreach( $res12 as $row2){  if($row2['F1S4']==""){ }else{ ?>

        <th colspan="3">Section 4 Ethics Committee  <?php echo $row2['EthicsID'] ?> Feedback</th>

        <tr> <td colspan="3"><?php echo  $row2['F1S4']; } ?></tr> 
    ...
    <tr>
      ...
      <td colspan="2"><?php echo $row1["Q1"];?></td>
        ...
        <?php if($row['S1']==""){ }else{ ?>
           ...
           <th colspan="3">Section 1 Reviewer <?php echo $row['ReviewerID'] ?> Feedback</th>

      

           <tr><td colspan="3"><?php echo $row['S1']; }?></td></tr>

        <tr> 

         <tr> 

            <?php if($row14['S1']==""){ }else{ ?>

           <th colspan="3">Section 1 Reviewer <?php echo $row14['ReviewerID'] ?>  Feedback</th>

      

           <tr><td colspan="3"><?php echo $row14['S1']; }?></td></tr>

        <tr> 

        <?php    foreach( $res12 as $row2){  if($row2['S1']==""){ }else{ ?>

        <th colspan="3">Section 1 Ethics Committee  <?php echo $row2['EthicsID'] ?> Feedback</th>

        <tr> <td colspan="3"><?php echo  $row2['S1']; } ?></tr> 
    ...
    if($row1 = mysqli_fetch_assoc($result2)) {
     ...
     <tr>
      ...
      <?php if($row['S2']==""){ }else{ ?>
           ...
           <th colspan="3">Section 2 Reviewer <?php echo $row['ReviewerID'] ; ?> Feedback</th>

      

           <tr><td colspan="3"><?php echo $row['S2']; }?></td></tr>

        <tr> 

         <tr> 

            <?php if($row14['S2']==""){ }else{ ?>

           <th colspan="3">Section 2 Reviewer <?php echo $row14['ReviewerID'] ?>  Feedback</th>

      

           <tr><td colspan="3"><?php echo $row14['S2']; }?></td></tr>

        <tr> 

        <?php    foreach( $res12 as $row2){  if($row2['S2']==""){ }else{ ?>

        <th colspan="3">Section 2 Ethics Committee  <?php echo $row2['EthicsID'] ?> Feedback</th>

        <tr> <td colspan="3"><?php echo  $row2['S2']; } ?></tr> 
...
if($row2 = mysqli_fetch_assoc($r)) {
  ...
  ?>
    ...
    <?php if($row['S3']==""){ }else{ ?>
           ...
           <th colspan="3">Section 3 Reviewer <?php echo $row['ReviewerID'] ?> Feedback</th>

      

           <tr><td colspan="3"><?php echo $row['S3']; }?></td></tr>

       

        <tr> 

            <?php if($row14['S3']==""){ }else{ ?>

           <th colspan="3">Section 3 Reviewer <?php echo $row14['ReviewerID'] ?>  Feedback</th>

      

           <tr><td colspan="3"><?php echo $row14['S3']; }?></td></tr>

        <tr>  

        <?php    foreach( $res12 as $row2){  if($row2['S3']==""){ }else{ ?>

        <th colspan="3">Section 3 Ethics Committee  <?php echo $row2['EthicsID'] ?> Feedback</th>

        <tr> <td colspan="3"><?php echo  $row2['S3']; } ?></tr> 
  ...
  ?>
    ...
    <tr>
     ...
     <?php if($row['S4']==""){ }else{ ?>
           ...
           <tr><td colspan="3"><?php echo $row['S4']; }?></td></tr>

        <tr> 

            <?php if($row14['S4']==""){ }else{ ?>

           <th colspan="3">Section 4 Reviewer <?php echo $row14['ReviewerID'] ?>  Feedback</th>

      

           <tr><td colspan="3"><?php echo $row14['S4']; }?></td></tr>

        <tr> 

        <?php    foreach( $res12 as $row2){  if($row2['S4']==""){ }else{ ?>

        <th colspan="3">Section 4 Ethics Committee  <?php echo $row2['EthicsID'] ?> Feedback</th>

        <tr> <td colspan="3"><?php echo  $row2['S4']; } ?></tr> 
    ...
    <tr>
      ...
      <td colspan="2"><?php echo $row2["Q3"];?></td>
        ...
        <?php if($row['S5']==""){ }else{ ?>
           ...
           <th colspan="3">Section 5 Reviewer <?php echo $row['ReviewerID'] ?>  Feedback</th>

      

           <tr><td colspan="3"><?php echo $row['S5']; }?></td></tr>

        <tr> 

        

        <?php if($row14['S5']==""){ }else{ ?>

           <th colspan="3">Section 5 Reviewer <?php echo $row14['ReviewerID'] ?>  Feedback</th>

      

           <tr><td colspan="3"><?php echo $row14['S5']; }?></td></tr>

        <tr> 

        <?php    foreach( $res12 as $row2){  if($row2['S5']==""){ }else{ ?>

        <th colspan="3">Section 5 Ethics Committee  <?php echo $row2['EthicsID'] ?> Feedback</th>

        <tr> <td colspan="3"><?php echo  $row2['S5']; } ?></tr> 
  ...
  ?>
    ...
    <tr>
      ...
      <?php if($row['S6']==""){ }else{ ?>
           ...
           <th colspan="3">Section 6 Reviewer <?php echo $row['ReviewerID'] ?> Feedback</th>

      

           <tr><td colspan="3"><?php echo $row['S6']; }?></td></tr>

         <tr> 

            <?php if($row14['S6']==""){ }else{ ?>

           <th colspan="3">Section 6 Reviewer <?php echo $row14['ReviewerID'] ?>  Feedback</th>

      

           <tr><td colspan="3"><?php echo $row14['S6']; }?></td></tr>

        <tr>

        <?php    foreach( $res12 as $row2){  if($row2['S6']==""){ }else{ ?>

        <th colspan="3">Section 6 Ethics Committee  <?php echo $row2['EthicsID'] ?> Feedback</th>

        <tr> <td colspan="3"><?php echo  $row2['S6']; } ?></tr> 
...
<?php if($row['S7']==""){ }else{ ?>
           ...
           <th colspan="3">Section 7 Reviewer <?php echo $row['ReviewerID'] ?>  Feedback</th>

      

           <tr><td colspan="3"><?php echo $row['S7']; }?></td></tr>

         <tr> 

            <?php if($row14['S7']==""){ }else{ ?>

           <th colspan="3">Section 7 Reviewer <?php echo $row14['ReviewerID'] ?>  Feedback</th>

      

           <tr><td colspan="3"><?php echo $row14['S7']; }?></td></tr>

        <tr>  

        <?php    foreach( $res12 as $row2){  if($row2['S7']==""){ }else{ ?>

        <th colspan="3">Section 7 Ethics Committee  <?php echo $row2['EthicsID'] ?> Feedback</th>

        <tr> <td colspan="3"><?php echo  $row2['S7']; } ?></tr> 
...
<?php if($row['S8']==""){ }else{ ?>
           ...
           <th colspan="3">Section 8 Reviewer <?php echo $row['ReviewerID'] ?> Feedback</th>

      

           <tr><td colspan="3"><?php echo $row['S8']; }?></td></tr>

         <tr> 

            <?php if($row14['S8']==""){ }else{ ?>

           <th colspan="3">Section 8 Reviewer <?php echo $row14['ReviewerID'] ?>  Feedback</th>

      

           <tr><td colspan="3"><?php echo $row14['S8']; }?></td></tr>

        <tr>

            <?php    foreach( $res12 as $row2){  if($row2['S8']==""){ }else{ ?>

        <th colspan="3">Section 8 Ethics Committee  <?php echo $row2['EthicsID'] ?> Feedback</th>

        <tr> <td colspan="3"><?php echo  $row2['S8']; } ?></tr> 
    ...
    <tr>
     ...
     <td colspan="2"><?php echo $row2["Q4"];?></td>
      ...
      <?php if($row['S9']==""){ }else{ ?>
           ...
           <th colspan="3">Section 9 Reviewer <?php echo $row['ReviewerID'] ?>  Feedback</th>

      

           <tr><td colspan="3"><?php echo $row['S9']; }?></td></tr>

         <tr> 

            <?php if($row14['S9']==""){ }else{ ?>

           <th colspan="3">Section 9 Reviewer <?php echo $row14['ReviewerID'] ?>  Feedback</th>

      

           <tr><td colspan="3"><?php echo $row14['S9']; }?></td></tr>

        <tr>  

        <?php    foreach( $res12 as $row2){  if($row2['S9']==""){ }else{ ?>

        <th colspan="3">Section 9 Ethics Committee  <?php echo $row2['EthicsID'] ?> Feedback</th>

        <tr> <td colspan="3"><?php echo  $row2['S9']; } ?></tr> 
    ...
    <tr>
      ...
      <td colspan="2"><?php echo $row2["Q6"];?></td>
         ...
         <?php if($row['S10']==""){ }else{ ?>
           ...
           <th colspan="3">Section 10 Reviewer <?php echo $row['ReviewerID'] ;?>  Feedback</th>

      

           <tr><td colspan="3"><?php echo $row['S10']; }?></td></tr>

         <tr> 

            <?php if($row14['S10']==""){ }else{ ?>

           <th colspan="3">Section 10 Reviewer <?php echo $row14['ReviewerID'] ?>  Feedback</th>

      

           <tr><td colspan="3"><?php echo $row14['S10']; }?></td></tr>

        <tr> 

        

        <?php    foreach( $res12 as $row2){  if($row2['S10']==""){ }else{ ?>

        <th colspan="3">Section 10 Ethics Committee  <?php echo $row2['EthicsID'] ?> Feedback</th>

        <tr> <td colspan="3"><?php echo  $row2['S10']; } ?></tr> 
