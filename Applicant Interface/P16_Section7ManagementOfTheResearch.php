...
$row1 = array("Q1"=>"","Q2"=>"","Q3"=>"");
    ...
    $sql2 = "SELECT MAX(version) as max FROM Full_Section7_Management_of_the_research WHERE ApplicationID=" . $ApplicationID;
    $result2 = mysqli_query($conn, $sql2);
    $row = mysqli_fetch_assoc($result2);
    $max= $row['max'];
     
    $sql1 = "SELECT * FROM Full_Section7_Management_of_the_research WHERE ApplicationID='$ApplicationID' and version='$max'"; 
...
<title>
Automatic Ethical Approval System: Section 7 Management of the research
</title>
...
<form id="my-form" action= "../PHP/Section7_ManagementOfTheResearch.php" method="post">
  <div class="container">
  ...
  <?php $result1 = substr($row1['Q2'], 0,3); ?>
    <?php  if($result1=='Yes'){?>
    <br><input type="radio" id="yes1" name="q2part1" onclick="manageTextArea(true, 'area1');" value="Yes" checked>
    <?php }else{?>
    <br><input type="radio" id="yes1" name="q2part1" onclick="manageTextArea(true, 'area1');" value="Yes">
    <?php }?>
...
<?php if($result1=='No'||$result1=='No '){?>
        <input type="radio" id="no1" name="q2part1" onclick="manageTextArea(false, 'area1');" value="No"checked>
     <?php }else{ ?>   
        <input type="radio" id="no1" name="q2part1" onclick="manageTextArea(false, 'area1');" value="No">
<?php }?>
  ...
  <div class="pageButtons">
        <input id="nextpage" type="hidden" name="nextpage" value="../Applicant Interface/P17_Section8InsuranceIndemnity.php">
