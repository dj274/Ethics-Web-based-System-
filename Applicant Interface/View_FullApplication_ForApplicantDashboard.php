...
$resulta = mysqli_query($conn, $sqla);
 ...
 $sql3 = "SELECT * FROM Section3_Declaration WHERE ApplicationID='$ApplicationID' and version='$max'ORDER BY ApplicationID ASC";
...
<body>
  ...
  <h1>
     ...
     for($x;$x<=$max2;$x++){ ?>
    <?php  if($max==$x){ ?>
     <button type="submit" class="button" style ="background-color: #4CAF50;"onclick=" window.open('View_FullApplication_ForApplicantDashboard.php?id=<?php echo $ApplicationID ;?>&id2=<?php echo $x ;?>', '_self'); return false;" >version <?php echo $x ; ?></button>
     
     <?php  }else{ ?>
     <button type="submit" class="button" onclick=" window.open('View_FullApplication_ForApplicantDashboard.php?id=<?php echo $ApplicationID ;?>&id2=<?php echo $x ;?>', '_self'); return false;" >version <?php echo $x ; ?></button>
...
?>
 ...
 <?php }  ?>
    ...
    <th style="background-color:#FF8989;"colspan="3">Section 2 Reviewer 1 Feedback</th>
 ...
 if($row2 = mysqli_fetch_assoc($result7)) {
  ...
  ?>
    ...
    <?php if($row4['S7']==""){ }else{ ?>
		...
		<th style="background-color:#FF8989;"colspan="3">Section 7 Reviewer 1 Feedback</th>

       <tr><td style="background-color:#FF8989;"colspan="3"><?php echo $row4['S7']; } ?></td></tr>
  ...
  ?>
     ...
     <tr>
      ...
      <?php if($row4['S8']==""){ }else{ ?>
		...
		<th style="background-color:#FF8989;"colspan="3">Section 8 Reviewer 1 Feedback</th>

       <tr><td style="background-color:#FF8989;"colspan="3"><?php echo $row4['S8']; } ?></td></tr>
    ...
    <tr>  
        ...
        <th style="background-color:#FF8989;"colspan="3">Section 8 Ethics Committee  <?php echo $row['EthicsID'] ?> Feedback</th>
    ...
    <tr>
     ...
     <td colspan="2"><?php echo $row2["Q4"];?></td>
      ...
      <?php if($row4['S9']==""){ }else{ ?>
		...
		<th style="background-color:#FF8989;"colspan="3">Section 9 Reviewer 1 Feedback</th>

       <tr><td style="background-color:#FF8989;"colspan="3"><?php echo $row4['S9']; } ?></td></tr>
  ...
  ?>
    ...
    <tr>
      ...
      <?php if($row4['S10']==""){ }else{ ?>
		...
		<th style="background-color:#FF8989;"colspan="3">Section 10 Reviewer 1 Feedback</th>

       <tr><td style="background-color:#FF8989;"colspan="3"><?php echo $row4['S10']; } ?></td></tr>
